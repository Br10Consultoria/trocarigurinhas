    ...
    <div className="min-h-screen bg-[#f7faff] text-slate-950">
      ...
      <main className="container py-8 sm:py-12">
        ...
        <Tabs defaultValue="history" className="mt-8">
          <TabsList className="h-auto w-full justify-start gap-2 rounded-2xl bg-white p-2 shadow-sm sm:w-fit"><TabsTrigger value="history" className="rounded-xl px-4 py-2.5 text-xs data-[state=active]:bg-blue-700 data-[state=active]:text-white"><History className="mr-2 h-4 w-4" />Histórico</TabsTrigger><TabsTrigger value="reservations" className="rounded-xl px-4 py-2.5 text-xs data-[state=active]:bg-blue-700 data-[state=active]:text-white"><Clock3 className="mr-2 h-4 w-4" />Reservas ativas</TabsTrigger><TabsTrigger value="account" className="rounded-xl px-4 py-2.5 text-xs data-[state=active]:bg-blue-700 data-[state=active]:text-white"><UserRound className="mr-2 h-4 w-4" />Minha conta</TabsTrigger></TabsList>
